        ...
        return(
            <React.Fragment>
                <ul className="brand-style-2">
                    <li>
                        <img src="/assets/images/brand/Amal-Training-Logo.jpeg" alt="Amal Training Logo Image"/>
                    </li>
                    <li>
                        <img src="/assets/images/brand/DigitalElite-Black-Logo.png" alt="Digital Elite Logo Image"/>
                    </li>
                    {/* <li>

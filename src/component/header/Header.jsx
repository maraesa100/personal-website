            ...
            <header className={`header-area formobile-menu header--transparent ${color}`}>
                <div className="header-wrapper" id="header-wrapper">
                    ...
                    <div className="header-right">
                            ...
                            <ul className="mainmenu">
                                ...
                                <li className="has-droupdown"><Link to="/service" >Service</Link>
                                    <ul className="submenu">
                                        <li><Link to="/mvp-service">MVP Service</Link></li>
                                        <li><Link to="/maintenance-service">Maintenance</Link></li>
                        ...
                        <div style={{ display: this.props.hideContactButton ? 'none' : 'flex' }} className="header-btn">
